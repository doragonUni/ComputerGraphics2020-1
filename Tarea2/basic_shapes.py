...
def createColorRectangleWing(r,g,b):
...
def createColorRectangleTail(r,g,b):
...
def createColorRectangleTailNormal(r,g,b):

    # Defining the location and colors of each vertex  of the shape
    vertices = [
    #   positions         colors   normals
    # Z+
        -0.3, -0.75,  0.2, r, g, b, 0,0,1,
         0.3, -0.75,  0.2, r, g, b, 0,0,1,
         0.3,  0.75,  0.2, r, g, b, 0,0,1,
        -0.3,  0.75,  0.2, r, g, b, 0,0,1,
...
def createColorRectangleWingNormal(r,g,b):

    # Defining the location and colors of each vertex  of the shape
    vertices = [
    #   positions         colors   normals
    # Z+
        -0.3, -0.65,  0.2, r, g, b, 0,0,1,
         0.3, -0.65,  0.2, r, g, b, 0,0,1,
         0.3,  0.65,  0.2, r, g, b, 0,0,1,
        -0.3,  0.65,  0.2, r, g, b, 0,0,1,
...
def createTexturefloor(image_filename, nx=1, ny=1):
